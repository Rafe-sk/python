#WAP to  calculate parking charges of a vehicle. enter the type of vehicle as a char (c for car, b for bus, etc..).
#and no. of hours then calculate charges as given below.
# truck/bus=20/hour
# car=10/hour
# scooter/cycle/bike=5/hour

print("--------------Hello and welcome to KING's  parking lot-----------------")
...
carname=input("Enter the name of your car:-")
...
if hours <3 :
        if typeofcar.upper()=="C":
            print('Name\t|\tCheckin\t|\tCheckout\t|\tHours\t|\tRent\t|\tCar name')
